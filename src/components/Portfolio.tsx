...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/3 w-2 h-24 bg-gradient-to-t from-accent/20 to-transparent animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="section-padding container-max relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-secondary-foreground/80 max-w-2xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Nossa comunicação se mede em <span className="text-primary font-semibold">conexões reais</span>.
          </p>
          <p className="text-secondary-foreground/80 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
