  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 hover:scale-105 border border-gray-100 group relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="h-16 bg-gradient-to-r from-primary/10 to-accent/10 rounded-xl mb-4 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
          <span className="text-lg font-bold text-primary group-hover:animate-pulse">{name}</span>
        </div>
